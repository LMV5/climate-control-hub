...
export default function NavBar() {
  ...
  return (
    <nav className="flex h-[2.3rem] gap-8">
      ...
      <ul
        className={`z-50 text-2xl sm:text-xl flex flex-col sm:flex-row items-start sm:items-center gap-10 sm:gap-8 absolute sm:static top-0 left-0 w-full h-screen sm:h-auto bg-gray-800 sm:bg-transparent p-6 sm:p-0 transition-transform duration-300 ${
